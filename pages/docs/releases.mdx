...
[v0.4.43](https://github.com/vietanhdev/anylabeling/releases/tag/v0.4.43) improves recovery and annotation persistence:
...
See [Hardware Acceleration](./gpu) for installation and device selection. No binary artifacts were published for v0.4.39; use v0.4.43 or newer for installers containing this work.
