...
The current stable release is [v0.4.43](https://github.com/vietanhdev/anylabeling/releases/tag/v0.4.43). Python installations require Python 3.11 or newer; Python 3.12 is recommended.
