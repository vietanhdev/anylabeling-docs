...
- **Current release:** [v0.4.43](https://github.com/vietanhdev/anylabeling/releases/tag/v0.4.43)
...
AnyLabeling v0.4.43 provides SHA-256 digests and native-runner launch checks for CPU and accelerated binaries on Linux, Windows, and Apple Silicon macOS. It fixes recovery after model download/load failures, invalid SAM preload images, grouped-shape persistence and undo, and reliable label-file closure.
