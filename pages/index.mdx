...
<div className="home-content">
  <div className="content-container">
    ...
    <div className="flex flex-col items-center gap-4 max-w-2xl mt-6">
      <a href="https://github.com/nrl-ai/anylearning-oss" target="_blank" rel="noopener noreferrer">
        <img className="w-full rounded-2xl" src="https://raw.githubusercontent.com/nrl-ai/anylearning-oss/main/website/public/screenshot.png" alt="AnyLearning open-source offline AI platform" />
      </a>
    </div>
  </div>
